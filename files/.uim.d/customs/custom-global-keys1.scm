(define generic-on-key '("zenkaku-hankaku" "<Super> " "<Control> "))
(define generic-on-key? (make-key-predicate '("zenkaku-hankaku" "<Super> " "<Control> ")))
(define generic-off-key '("zenkaku-hankaku" "<Super> " "<Control> "))
(define generic-off-key? (make-key-predicate '("zenkaku-hankaku" "<Super> " "<Control> ")))
...
(define generic-next-candidate-key '("<Alt>Shift_key"))
(define generic-next-candidate-key? (make-key-predicate '("<Alt>Shift_key")))
