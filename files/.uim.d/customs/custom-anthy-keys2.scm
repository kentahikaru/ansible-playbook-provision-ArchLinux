(define anthy-on-key '("zenkaku-hankaku" "<Super> " "<Control> "))
(define anthy-on-key? (make-key-predicate '("zenkaku-hankaku" "<Super> " "<Control> ")))
(define anthy-off-key '("zenkaku-hankaku" "<Super> " "<Control> "))
(define anthy-off-key? (make-key-predicate '("zenkaku-hankaku" "<Super> " "<Control> ")))
