(define anthy-on-key '("zenkaku-hankaku" "<Super> "))
(define anthy-on-key? (make-key-predicate '("zenkaku-hankaku" "<Super> ")))
(define anthy-off-key '("zenkaku-hankaku" "<Super> "))
(define anthy-off-key? (make-key-predicate '("zenkaku-hankaku" "<Super> ")))
